...
<div id="MensagemErro" class="modal modal-danger fade" aria-hidden="true" style="width: 600px;">
    ...
    <div class="modal-footer">
        <button class="btn btn-outline pull-left" data-dismiss="modal" aria-hidden="true">Fechar</button>
    </div>
</div>

<!-- Modal de Pesquisa de Pessoa -->
<div id="MensagemSucesso" class="modal modal-success fade" aria-hidden="true" style="width: 600px;">
    <div class="modal-header">
        <h3>Sucesso</h3>
    </div>
    <div class="modal-body">
