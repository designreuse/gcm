...
<div class="container">
    <div class="container-fluid">
        <c:url value="/grupousuario_update" var="update"/>
        <form:form class="form-signin" modelAttribute="grupousuario" id="FormCadastro" action="${update}" method="PUT">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Editar Grupo de Usuário</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="id_GrupoUsuario" type="text" maxlength="3"
