...
<div class="container">
    <div class="container-fluid">
        <c:url value="/stb_update" var="update"/>
        <form:form class="form-signin" modelAttribute="stb" id="FormCadastro" action="${update}" method="PUT">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 34%;">Editar Situação Tributária B</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="id_STB" type="text" maxlength="3"
