...
<div class="container">
    <div class="container-fluid">
        <c:url value="/produto_insert" var="insert"/>
        <form:form class="form-signin" modelAttribute="produto" id="FormCadastro" action="${insert}" method="POST">
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Novo Produto</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span9" style="text-align: left;">
                        <form:input id="referencia" path="referencia" type="text" required="autofocus"
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3" style="text-align: left;">   <!--grupoProduto.id_GrupoProduto-->
                        <form:select path="" multiple="false" id="listaGrupo"
                                     cssClass="form-control" required="true"
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3" style="text-align: left;">
                        <form:input id="ValidadeAnvisa" path="validadeAnvisa" type="text" required="true"
                ...
                <div class="row-fluid">
                    ...
                    <div class="span1" style="text-align: left;">
                        <form:checkbox path="controlaLote" checked="true"/>
                    </div>
                    <div class="span3" style="text-align: left;">
