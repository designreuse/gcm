                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="10" style="width:100%;" required="autofocus" value="${produto.referencia}"  readonly="true"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" style="width:100%;" required="true" value="${produto.descricao}" readonly="true"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="id_MarcaProduto" id="id_MarcaProduto" required="true" disabled="true">
                                                <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" name="id_GrupoProduto" id="id_GrupoProduto" required="true" disabled="true">
                                                <option value=""></option>
                                        ...
                                        <div class="col-md-4">
                                            <select class="form-control" name="id_SubGrupoProduto" id="id_SubGrupoProduto" required="true" disabled="true">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <select class="form-control" name="id_STA" id="id_STA" required="true" disabled="true">
                                                <option value=""></option>
                                        ...
                                        <div class="col-md-2">
                                            <select class="form-control" name="id_STB" id="id_STB" required="true" disabled="true">
                                                <option value=""></option>
                                        ...
                                        <div class="col-md-2">
                                            <select class="form-control" name="id_NCM" id="id_NCM" required="true" disabled="true">
                                                <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" name="id_UnidadePadrao" id="id_UnidadePadrao" required="true" disabled="true">
                                                <option value=""></option>
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" style="width:100%;" required="true" step="0.01" value="${produto.pesoBruto}" readonly="true"
                                                   class="form-control" placeholder="P.Bruto" name="pesoBruto" id="pesoBruto"/>
                                        </div>
                                        <div class="col-md-2">
                                            <input type="number" style="width:100%;" required="true" step="0.01" value="${produto.pesoLiquido}" readonly="true"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" style="width:100%;" value="${produto.numeroAnvisa}" readonly="true"
                                        ...
                                        <div class="col-md-2">
                                            <input type="date" value="${produto.validadeAnvisa}" readonly="true"
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="col-sm-12" style="margin-top: 15px; text-align: center;">
                                <a style="width: 80px" href="<c:url value="/produto_lista"/>" class="btn btn-primary" title="Voltar">Voltar</a>
                            </div>
                        </div>
                    </div>
                </div>
