...
<div class="content body">
    <form action="/cfop_update" method="post">
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" style="width:100%;" required="autofocus" value="${cfop.descricao}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                <c:when test="${cfop.exigeRetorno == 'true'}">
                                                    <input type="checkbox" name="ckbexigeRetorno" id="ckbexigeRetorno" style="margin-top: 10px;" checked/>
                                                </c:when>
                                        ...
                                        <div class="col-md-1">
                                            <input type="number" maxlength="3" style="width:100%;" required="true" min="0" max="999"
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                <c:when test="${cfop.ajuste == 'true'}">
                                                    <input type="checkbox" name="ckbajuste" id="ckbajuste" style="margin-top: 10px;" checked/>
                                                </c:when>
