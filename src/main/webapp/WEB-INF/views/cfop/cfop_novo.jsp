...
<div class="container">
    <div class="container-fluid">
        <c:url value="/cfop_insert" var="gravar"/>
        <form:form class="form-signin" modelAttribute="cfop" id="FormCadastro" action="${gravar}" method="POST">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Novo CFOP</a>
                    </div>
                </div>
            </div>
