    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                <a class="brand" style="font: bold; margin-left: 300px;">Lista de Centro de Custo</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="navbar-inner" style="overflow:auto; height: 350px;">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed active tabelaPaginada" id="example">
            ...
            <c:forEach items="${lista}" var="p">
                <tr>
                    <td>
                        <a href="/centrocusto_deleta/${p.id_CentroCusto}" class="btn btn-mini apagar" title="Deletar">
                            <i class="icon-trash"></i>
                        </a>
                        <a href="/centrocusto_editar/${p.id_CentroCusto}" class="btn btn-mini" title="Editar">
    ...
    <div class="navbar-inner">
        <div class="row-fluid">
            ...
            <div class="span6" style="text-align: right;" >
                <br>
                <a href="<c:url value="/centrocusto_novo"/>" class="btn btn-lg btn-primary" style="width: 70px;"><span class="icon-plus"></span> Novo</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    jQuery(function($){
        $("#Empresas").change(function(){
            location.href="/centrocusto_filtro/"+ $(this).val();
        });
    });
</script>
