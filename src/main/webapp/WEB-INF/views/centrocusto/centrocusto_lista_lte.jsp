    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="box box-primary">
                ...
                <div class="box-body">
                    <form class="form-horizontal" action="/centrocusto_lista" method="post">
                        <fieldset>
                            <div class="row">
                    ...
                    <table class="table table-bordered  table-hover table-striped">
                        ...
                        <tbody>
                            <c:forEach items="${lista}" var="p">
                                <tr>
                                    <td>
                                        <a href="/centrocusto_deleta/${p.id_CentroCusto}" class="btn btn-default btn-xs" title="Deletar">
                                            <i class="fa fa-trash-o"></i>
                                        </a>
                                        <a href="/centrocusto_editar/${p.id_CentroCusto}" class="btn btn-default btn-xs" title="Editar">
                                            <i class="fa fa-pencil"></i>
                                        </a>
                                        <a href="/centrocusto_detalhes/${p.id_CentroCusto}" class="btn btn-default btn-xs" title="Detalhes">
                                            <i class="fa fa-eye"></i>
                                        </a>
                                    </td>
                                    <td>${p.id_Empresa}</td>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    ...
                    <div class="col-sm-3" style="margin-top: 15px;">
                        <a style="width: 80px" href="<c:url value="/centrocusto_novo"/>" class="btn btn-primary" title="Novo">
