...
<div class="container">
    <div class="container-fluid">
        <c:url value="/centrocusto_update" var="gravar"/>
        <form:form class="form-signin" modelAttribute="centrocusto" id="FormCadastro" action="${gravar}" method="PUT">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Editar Centro de Custo</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span9" style="text-align: left;">
                        <form:input path="id_CentroCusto" class="form-control" type="hidden"/>
