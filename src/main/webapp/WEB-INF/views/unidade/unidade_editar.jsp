...
<div class="container">
    <div class="container-fluid">
        <c:url value="/unidade_update" var="update"/>
        <form:form class="form-signin" modelAttribute="unidade" id="FormCadastro" action="${update}" method="PUT">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 40%;">Editar Unidade</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="id_Unidade" type="text" maxlength="3"
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="sigla" type="text"  maxlength="50" required="autofocus"
                ...
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <a class="btn btn-lg btn-primary btn-block" style="width:100px;" href="<c:url value="/unidade_lista"/>">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
