...
<div class="container">
    <div class="container-fluid">
        <c:url value="/unidade_insert" var="gravar"/>
        <form:form class="form-signin" modelAttribute="unidade" id="FormCadastro" action="${gravar}" method="POST">
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="sigla" type="text"  maxlength="5" required="autofocus"
