...
<div class="content body">
    <form action="/unidade_update" method="post">
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="text" maxlength="3" style="width:60px;" required="autofocus" value="${unidade.sigla}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="50" style="width:100%;" required="true" value="${unidade.descricao}"
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="col-sm-12" style="margin-top: 15px; text-align: center;">
                                ...
                                <a style="width: 80px" href="<c:url value="/unidade_lista"/>" class="btn btn-primary" title="Cancelar">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
