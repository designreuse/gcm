...
<div class="container">
    <div class="container-fluid">
        <c:url value="/usuario_insert" var="insert"/>
        <form:form class="form-signin" modelAttribute="usuario" id="FormCadastro" action="${insert}" method="POST" autocomplete="off">
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Novo Usuário</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3" style="text-align: left;">
                        <form:input path="login" type="text" maxlength="25"
                    ...
                    <div class="span3" style="text-align: left;">
                        <form:password path="senha" class="span3" style="width:200px;" required="true"/>
                    </div>
                </div>
                <div class="row-fluid">
                    <div class="span3" style="text-align: left;">
