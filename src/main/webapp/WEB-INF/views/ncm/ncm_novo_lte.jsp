...
<div class="content body">
    <form action="/ncm_insert" method="post">
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" maxlength="10" style="width:100%;" required="true" min="0.00" step="0.01"
                                                   class="form-control" placeholder="IPI" name="aliquotaIPI" id="aliquotaIPI"/>
                                        </div>

                                        <label class="col-md-2 control-label" for="aliquotaII" style="margin-top: 5px;">Aliquota II</label>
                                        <div class="col-md-2">
                                            <input type="number" maxlength="10" style="width:100%;" required="true" min="0.00" step="0.01"
                                                   class="form-control" placeholder="II" name="aliquotaII" id="aliquotaII"/>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
