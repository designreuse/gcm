                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    ...
                                    <input type="text" maxlength="10" style="width:100%;" value="${ncm.codigoNCM}"
                                           class="form-control" placeholder="Código" name="codigoNCM" id="codigoNCM" readonly="true"/>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" maxlength="50" style="width:100%;" value="${ncm.descricao}"
                                           class="form-control" placeholder="Nome" name="descricao" id="descricao" readonly="true"/>
                                </div>
                            </div>
                            <br>
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <input type="number" maxlength="10" style="width:100%;" min="0.00" step="0.01"
                                           class="form-control" placeholder="IPI" name="aliquotaIPI" id="aliquotaIPI" value="${ncm.aliquotaIPI}" readonly="true"/>
                                </div>

                                <label class="col-md-2 control-label" for="aliquotaII" style="margin-top: 5px;">Aliquota II</label>
                                <div class="col-md-2">
                                    <input type="number" maxlength="10" style="width:100%;" min="0.00" step="0.01" readonly="true"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="id_CSTPIS" id="id_CSTPIS" disabled="true">
                                        <option value=""></option>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <select class="form-control" name="id_CSTCOFINS" id="id_CSTCOFINS" disabled="true">
                                        <option value=""></option>
                                        <c:forEach items="${lista_cst}" var="p">
                                            <c:choose>
            ...
            <div class="box box-primary">
                <div class="box-body">
                    <div class="col-sm-12" style="margin-top: 15px; text-align: center;">
                        <a style="width: 80px" href="<c:url value="/ncm_lista"/>" class="btn btn-primary" title="Voltar">Voltar</a>
                    </div>
                </div>
            </div>
        </div>
