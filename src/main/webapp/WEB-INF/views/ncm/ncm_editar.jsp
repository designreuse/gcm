...
<div class="container">
    <div class="container-fluid">
        <c:url value="/ncm_update" var="update"/>
        <form:form class="form-signin" modelAttribute="ncm" id="FormCadastro" action="${update}" method="PUT">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 43%;">Editar NCM</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span9" style="text-align: left;">
                        <form:input path="id_NCM" type="text" maxlength="3"
