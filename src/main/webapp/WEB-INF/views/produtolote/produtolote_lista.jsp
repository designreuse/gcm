    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                <a class="brand" style="font: bold; margin-left: 280px;">Lista de Lotes do Produto</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="navbar-inner" style="height: 290px; overflow:auto;">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed active tabelaPaginada" id="example">
            ...
            <c:forEach items="${lista}" var="p">
                <tr>
                    <td>
                        <a href="/produtolote_deleta/${p.id_ProdutoLote}/${p.id_Produto}" class="btn btn-mini apagar" title="Deletar">
                            <i class="icon-trash"></i>
                        </a>
                        <a href="/produtolote_editar/${p.id_ProdutoLote}" class="btn btn-mini" title="Editar">
    ...
    <div class="navbar-inner">
        <div class="row-fluid">
            ...
            <div class="span6" style="text-align: right;" >
                <br>
                <a href="<c:url value="/produtolote_novo/${produto.id_Produto}"/>" class="btn btn-lg btn-primary" style="width: 70px;"><span class="icon-plus"></span> Novo</a>
