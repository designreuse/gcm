...
<div class="content-header">
    <h1>Detalhes Lote do Produto</h1>
</div>
...
<div class="content body">
    ...
    <form action="/produtolote_update" method="post">
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                    <div class="box box-primary">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <input type="hidden" value="${produtolote.id_ProdutoLote}"
                                                   class="form-control" placeholder="Barras" name="id_ProdutoLote" id="id_ProdutoLote"/>

                                            <input type="text" style="width:100%;" required="true" maxlength="20" value="${produtolote.numeroLote}"
                                                   class="form-control" placeholder="Barras" name="numeroLote" id="numeroLote" readonly="true"/>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="date" style="width:100%;" required="true" value="${produtolote.dataFabricacao}" readonly="true"
                                        ...
                                        <div class="col-md-2">
                                            <input type="date" style="width:100%;" required="true" value="${produtolote.dataValidade}" readonly="true"
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="col-sm-12" style="margin-top: 15px; text-align: center;">
                                <a style="width: 80px" href="<c:url value="/produtolote_lista/${produto.id_Produto}"/>" class="btn btn-primary" title="Voltar">Voltar</a>
                            </div>
                        </div>
                    </div>
                </div>
