                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="date" style="width:100%;" required="true" value="${produtolote.dataFabricacao}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="date" style="width:100%;" required="true" value="${produtolote.dataValidade}"
