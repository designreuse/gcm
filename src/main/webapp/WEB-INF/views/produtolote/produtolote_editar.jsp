...
<div class="container">
    <div class="container-fluid">
        <c:url value="/produtolote_update" var="gravar"/>
        <form:form class="form-signin" modelAttribute="produtolote" id="FormCadastro" action="${gravar}" method="PUT">
                ...
                <div class="row-fluid">
                    <div class="row-fluid">
                        ...
                        <div class="span9" style="text-align: left;">
                            <form:input path="id_ProdutoLote" id="id_ProdutoLote" type="hidden" maxlength="50" class="form-control" name="id_ProdutoLote" style="width:80px;" />
