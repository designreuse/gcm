...
<div class="content body">
    <form action="/alterar_uf" method="post" >
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="3" style="width:60px;" required="true" value="${uf.siglaUf}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="50" style="width:100%;" required="true" value="${uf.descricao}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="5" style="width:100%;" value="${uf.ibge}"
