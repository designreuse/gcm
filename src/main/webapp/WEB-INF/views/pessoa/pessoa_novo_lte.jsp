...
<div class="content body">
    <form action="/pessoa_insert/${tipo}" method="post">
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                        ...
                        <div class="box-body">
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <div class="row">
                                        <label class="col-md-2 control-label" for="cpfCnpj" style="margin-top: 5px;">Cpf\Cnpj</label>
                                        <div class="col-md-2">
                                            <input type="text" maxlength="13" style="width:100%;" required="autofocus"
                                        ...
                                        <div class="col-md-2">
                                            <input type="hidden" value="True" readonly="True" name="ativo" id="ativo"/>
                                            <input type="checkbox" class="ckb" name="ckbativo" id="ckbativo" style="margin-top: 10px;"checked disabled/>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                <c:when test="${tipo == 'CLI'}">
                                                    ...
                                                    <input type="hidden" value="True" name="tipoCliente" id="tipoCliente"/>
                                                </c:when>
                                                <c:when test="${tipo != 'CLI'}">
                                                    <input type="checkbox" name="ckbCliente" id="ckbCliente" style="margin-top: 10px;"/>
                                                    <input type="hidden" value="False" name="tipoCliente" id="tipoCliente"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                ...
                                                <c:when test="${tipo != 'FOR'}">
                                                    ...
                                                    <input type="hidden" value="False" name="tipoFornecedor" id="tipoFornecedor"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                ...
                                                <c:when test="${tipo != 'VEN'}">
                                                    ...
                                                    <input type="hidden" value="False" name="tipoVendedor" id="tipoVendedor"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                ...
                                                <c:when test="${tipo != 'FUN'}">
                                                    ...
                                                    <input type="hidden" value="False" name="tipoFuncionario" id="tipoFuncionario"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                <c:when test="${tipo == 'CON'}">
                                                    <input class="ckb" type="checkbox" name="ckbConvenio" id="ckbConvenio" style="margin-top: 10px;" checked disabled/>
                                                    <input type="hidden" value="True" name="tipoConvenio" id="tipoConvenio"/>
                                                </c:when>
                                                <c:when test="${tipo != 'CON'}">
                                                    <input class="ckb" type="checkbox" name="ckbConvenio" id="ckbConvenio" style="margin-top: 10px;"/>
                                                    <input type="hidden" value="False" name="tipoConvenio" id="tipoConvenio"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                ...
                                                <c:when test="${tipo != 'HOS'}">
                                                    ...
                                                    <input type="hidden" value="False" name="tipoHospital" id="tipoHospital"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                <c:when test="${tipo == 'MED'}">
                                                    <input type="checkbox" class="ckb" name="ckbMedico" id="ckbMedico" style="margin-top: 10px;" checked disabled/>
                                                    <input type="hidden" value="True" name="tipoMedico" id="tipoMedico"/>
                                                </c:when>
                                                <c:when test="${tipo != 'MED'}">
                                                    <input type="checkbox" class="ckb" name="ckbMedico" id="ckbMedico" style="margin-top: 10px;"/>
                                                    <input type="hidden" value="False" name="tipoMedico" id="tipoMedico"/>
                                                </c:when>
                                            </c:choose>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                ...
                                                <c:when test="${tipo != 'ENF'}">
                                                    ...
                                                    <input type="hidden" value="False" name="tipoEnfermeiro" id="tipoEnfermeiro"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                ...
                                                <c:when test="${tipo != 'TRA'}">
                                                    ...
                                                    <input type="hidden" value="False" name="tipoTransportador" id="tipoTransportador"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                        ...
                                        <div class="col-md-1">
                                            <c:choose>
                                                ...
                                                <c:when test="${tipo != 'PAC'}">
                                                    ...
                                                    <input type="hidden" value="False" name="tipoPaciente" id="tipoPaciente"/>
                                                </c:when>
                                            </c:choose>
                                        </div>
                                    </div>
