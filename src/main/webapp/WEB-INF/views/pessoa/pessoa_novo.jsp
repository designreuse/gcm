...
<div class="container">
    <div class="container-fluid">
        <c:url value="/pessoa_insert/${tipo}" var="gravar"/>
        <form:form class="form-signin" modelAttribute="pessoa" id="FormCadastro" action="${gravar}" method="POST">
                    ...
                    <div class="container-fluid">
                        <c:choose>
                            <c:when test="${tipo == 'CLI'}">
                                <a class="brand" id="Tipo" tipo="CLI" style="font: bold; margin-left: 40%">Novo Cliente</a>
                            </c:when>
                            <c:when test="${tipo == 'FOR'}">
                                <a class="brand" id="Tipo" tipo="FOR" style="font: bold; margin-left: 35%;">Novo Fornecedor</a>
                            </c:when>
                            <c:when test="${tipo == 'FUN'}">
                                <a class="brand" id="Tipo" tipo="FUN" style="font: bold; margin-left: 35%;">Novo Funcionário</a>
                            </c:when>
                            <c:when test="${tipo == 'VEN'}">
                                <a class="brand" id="Tipo" tipo="VEN" style="font: bold; margin-left: 40%;">Novo Vendedor</a>
                            </c:when>
                            <c:when test="${tipo == 'TRA'}">
                                <a class="brand" id="Tipo" tipo="TRA" style="font: bold; margin-left: 35%;">Novo Transportador</a>
                            </c:when>
                            <c:when test="${tipo == 'CON'}">
                                <a class="brand" id="Tipo" tipo="CON" style="font: bold; margin-left: 40%;">Novo Convênio</a>
                            </c:when>
                            <c:when test="${tipo == 'HOS'}">
                                <a class="brand" id="Tipo" tipo="HOS" style="font: bold; margin-left: 40%;">Novo Hospital</a>
                            </c:when>
                            <c:when test="${tipo == 'MED'}">
                                <a class="brand" id="Tipo" tipo="MED" style="font: bold; margin-left: 40%;">Novo Médico</a>
                            </c:when>
                            <c:when test="${tipo == 'ENF'}">
                                <a class="brand" id="Tipo" tipo="ENF" style="font: bold; margin-left: 40%;">Novo Enfermeiro</a>
                            </c:when>
                            <c:when test="${tipo == 'PAC'}">
                                <a class="brand" id="Tipo" tipo="PAC" style="font: bold; margin-left: 40%;">Novo Paciênte</a>
                            </c:when>
                        </c:choose>
                    </div>
                </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span5" style="text-align: left;">
                        <form:select path="" multiple="false" id="listaPais" required="true"
                    ...
                    <div class="span3" style="text-align: right;">
                        <form:select  path="" multiple="false" id="listaUf" required="true"
                                      style="width:165px;" cssClass="form-control"
                                      itemLabel="siglauf"
                                      itemValue="id_uf" />
                    </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span5" style="text-align: left;">
                        <form:input path="email" type="text"  maxlength="200" id="Email"
