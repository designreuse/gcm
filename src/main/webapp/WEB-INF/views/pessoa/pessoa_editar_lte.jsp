                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="13" style="width:100%;" required="autofocus" value="${pessoa.cpfCnpj}"
                                                   class="form-control" placeholder="Cpf\Cnpj" name="cpfCnpj" id="cpfCnpj"/>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" style="width:100%;" required="true" value="${pessoa.razaoSocial}"
                                                   class="form-control" placeholder="Razão Social" name="razaoSocial" id="razaoSocial"/>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" style="width:100%;" value="${pessoa.nomeFantasia}"
                                                   class="form-control" placeholder="Nome Fantasia" name="nomeFantasia" id="nomeFantasia"/>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" maxlength="20" style="width:100%;" value="${pessoa.inscricaoEstadual}"
                                                   class="form-control" placeholder="Insc. Estadual" name="inscricaoEstadual" id="inscricaoEstadual"/>
                                        </div>
                                        <label class="col-md-2 control-label" for="inscricaoMunicipal" style="margin-top: 5px;">Insc. Municipal</label>
                                        <div class="col-md-3">
                                            <input type="text" maxlength="20" style="width:100%;" value="${pessoa.inscricaoMunicipal}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" maxlength="20" style="width:100%;" value="${pessoa.rg}"
                                        ...
                                        <div class="col-md-3">
                                            <input type="date" style="width:100%;" required="true" value="${pessoa.dataNascimento}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" style="width:100%;" value="${pessoa.endereco}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" maxlength="10" style="width:100%;" value="${pessoa.numero}"
                                        ...
                                        <div class="col-md-3">
                                            <input type="text" maxlength="8" style="width:100%;" value="${pessoa.cep}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" style="width:100%;" value="${pessoa.bairro}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <select class="form-control" name="id_pais" id="id_pais" required="true">
                                                <option value=""></option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <select class="form-control" name="id_Municipio" id="id_Municipio" required="true">
                                                <option value=""></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="15" style="width:100%;" value="${pessoa.telefone1}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="15" style="width:100%;" value="${pessoa.telefone2}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="15" style="width:100%;" value="${pessoa.fax}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" style="width:100%;" value="${pessoa.email}"
                                                ...
                                                <c:when test="${tipo != 'CLI'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoCliente == 'true'}">
                                                            <input type="checkbox" name="ckbCliente" id="ckbCliente" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoCliente == 'false'}">
                                                            <input type="checkbox" name="ckbCliente" id="ckbCliente" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'FOR'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoFornecedor == 'true'}">
                                                            <input type="checkbox" name="ckbFornecedor" id="ckbFornecedor" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoFornecedor == 'false'}">
                                                            <input type="checkbox" name="ckbFornecedor" id="ckbFornecedor" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'VEN'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoVendedor == 'true'}">
                                                            <input type="checkbox" name="ckbVendedor" id="ckbVendedor" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoVendedor == 'false'}">
                                                            <input type="checkbox" name="ckbVendedor" id="ckbVendedor" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'FUN'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoFuncionario == 'true'}">
                                                            <input type="checkbox" name="ckbFuncionario" id="ckbFuncionario" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoFuncionario == 'false'}">
                                                            <input type="checkbox" name="ckbFuncionario" id="ckbFuncionario" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'CON'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoConvenio == 'true'}">
                                                            <input type="checkbox" name="ckbConvenio" id="ckbConvenio" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoConvenio == 'false'}">
                                                            <input type="checkbox" name="ckbConvenio" id="ckbConvenio" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'HOS'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoHospital == 'true'}">
                                                            <input type="checkbox" name="ckbHospital" id="ckbHospital" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoHospital == 'false'}">
                                                            <input type="checkbox" name="ckbHospital" id="ckbHospital" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'MED'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoMedico == 'true'}">
                                                            <input type="checkbox" name="ckbMedico" id="ckbMedico" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoMedico == 'false'}">
                                                            <input type="checkbox" name="ckbMedico" id="ckbMedico" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'ENF'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoEnfermeiro == 'true'}">
                                                            <input type="checkbox" name="ckbEnfermeiro" id="ckbEnfermeiro" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoEnfermeiro == 'false'}">
                                                            <input type="checkbox" name="ckbEnfermeiro" id="ckbEnfermeiro" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'TRA'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoTransportador == 'true'}">
                                                            <input type="checkbox"  name="ckbTransportador" id="ckbTransportador" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoTransportador == 'false'}">
                                                            <input type="checkbox"  name="ckbTransportador" id="ckbTransportador" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                                                ...
                                                <c:when test="${tipo != 'PAC'}">
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${pessoa.tipoPaciente == 'true'}">
                                                            <input type="checkbox" name="ckbPaciente" id="ckbPaciente" style="margin-top: 10px;" checked/>
                                                        </c:when>
                                                        <c:when test="${pessoa.tipoPaciente == 'false'}">
                                                            <input type="checkbox" name="ckbPaciente" id="ckbPaciente" style="margin-top: 10px;"/>
                                                        </c:when>
                                                    </c:choose>
                                                </c:when>
                                            </c:choose>
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="col-sm-12" style="margin-top: 15px; text-align: center;">
                                ...
                                <a style="width: 80px" href="<c:url value="/pessoa_lista/${tipo}"/>" class="btn btn-primary" title="Cancelar">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
