...
<div class="container">
    <div class="container-fluid">
        <c:url value="/banco_update" var="gravar"/>
        <form:form class="form-signin" modelAttribute="banco" id="FormCadastro" action="${gravar}" method="PUT">
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span9" style="text-align: left;">
                        <form:input path="id_Banco" class="form-control" type="hidden"/>
