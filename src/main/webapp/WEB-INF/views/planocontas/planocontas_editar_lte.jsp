...
<div class="content body">
    <form action="/planocontas_update" method="post" >
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="20" readonly="true" value="${planocontas.codigoConta}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <input type="text" maxlength="50" required="true" value="${planocontas.descricao}"
