...
<c:url value="/movimentofinanceiro_update" var="gravar"/>
<form:form class="form-signin" modelAttribute="movimentofinanceiro" id="FormCadastro" action="${gravar}" method="PUT">
        ...
        <div class="container-fluid">
            <c:choose>
                <c:when test="${tipomovimento == 'C'}">
                    <a class="brand" style="font: bold; margin-left: 30%;">Editar Movimento Financeiro - Crédito</a>
                </c:when>
                <c:otherwise>
                    <a class="brand" style="font: bold; margin-left: 30%;">Editar Movimento Financeiro - Débito</a>
                </c:otherwise>
            </c:choose>
        </div>
    </div>
...
<div class="row-fluid">
    ...
    <div class="span2" style="text-align: left;">
        <form:input path="dataVencimento" type="text"  maxlength="10"
    ...
    <div class="span2" style="text-align: left;">
        <form:input path="dataCompetenciaIni" type="text"  maxlength="10"
    ...
    <div class="span2" style="text-align: left;">
        <form:input path="dataCompetenciaFim" type="text"  maxlength="10"
...
<div class="row-fluid">
    ...
    <div class="span2">
        <form:input path="valorVencimento" type="number"  maxlength="20"
