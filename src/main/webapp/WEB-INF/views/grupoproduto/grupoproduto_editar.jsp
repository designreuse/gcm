...
<div class="container">
    <div class="container-fluid">
        <c:url value="/grupoproduto_update" var="update"/>
        <form:form class="form-signin" modelAttribute="grupoproduto" id="FormCadastro" action="${update}" method="PUT">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Editar Grupo de Produtos</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="id_GrupoProduto" type="text" maxlength="3"
                ...
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <a class="btn btn-lg btn-primary btn-block" style="width:100px;" href="<c:url value="/grupoproduto_lista"/>">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
