...
<div class="container">
    <div class="container-fluid">
        <c:url value="/situacaotributariapiscofins_insert" var="gravar"/>
        <form:form class="form-signin" modelAttribute="stPISCOFINS" id="FormCadastro" action="${gravar}" method="POST">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 30%;">Nova Situação Tributária PIS\COFINS</a>
                    </div>
                </div>
            </div>
