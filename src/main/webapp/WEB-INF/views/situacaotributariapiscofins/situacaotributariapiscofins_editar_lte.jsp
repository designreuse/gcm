...
<div class="content-header">
    <h1>Editar Situação Tributária PIS\COFINS</h1>
</div>

<div class="content body">
    <form action="/stpiscofins_update" method="post">
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="50" style="width:100%;" required="autofocus" value="${stpiscofins.descricao}"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <c:choose>
                                                <c:when test="${stpiscofins.isentoAliquotaZero == 'true'}">
                                                    <input type="checkbox" name="ckbisento" id="ckbisento" style="margin-top: 10px;" checked/>
                                                </c:when>
