...
<div class="container">
    <div class="container-fluid">
        <c:url value="/alterar_municipio" var="gravarmunicipio"/>
        <form:form class="form-signin" modelAttribute="municipio" id="FormCadastro" action="${gravarmunicipio}" method="PUT">
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Edição de Município</a>
                    </div>
                </div>
            </div>
