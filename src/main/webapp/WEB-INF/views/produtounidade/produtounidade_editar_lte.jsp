                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" style="width:100%;" required="true" maxlength="20" value="${produtounidade.codigoBarras}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" style="width:100%;" required="true" step="0.01" value="${produtounidade.fatorConversao}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" style="width:100%;" required="true" step="0.01" value="${produtounidade.pesoBruto}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="number" style="width:100%;" required="true" step="0.01" value="${produtounidade.pesoLiquido}"
