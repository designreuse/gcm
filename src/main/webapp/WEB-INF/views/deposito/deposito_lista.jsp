    ...
    <div class="navbar">
        <div class="navbar-inner">
            <div class="container-fluid">
                <a class="brand" style="font: bold; margin-left: 300px;">Lista de Depósitos</a>
            </div>
        </div>
    </div>
</div>
    ...
    <div class="navbar-inner" style="height: 350px; overflow:auto;">
        ...
        <table class="table table-striped table-bordered table-hover table-condensed active tabelaPaginada" id="example">
            ...
            <c:forEach items="${deposito_lista}" var="p">
                <tr>
                    <td>
                        <a href="/deposito_deleta/${p.id_Deposito}" class="btn btn-mini apagar" title="Deletar">
                            <i class="icon-trash"></i>
                        </a>
                        <a href="/deposito_editar/${p.id_Deposito}" class="btn btn-mini" title="Editar">
    ...
    <div class="navbar-inner">
        <div class="row-fluid">
            ...
            <div class="span6" style="text-align: right;" >
                <br>
                <a href="<c:url value="/deposito_novo"/>" class="btn btn-lg btn-primary" style="width: 70px;"><span class="icon-plus"></span> Novo</a>
            </div>
        </div>
    </div>
</div>
...
<script>
    jQuery(function($){
        $("#Empresas").change(function(){
            location.href="/deposito_filtro/"+ $(this).val();
        });
    });
</script>
