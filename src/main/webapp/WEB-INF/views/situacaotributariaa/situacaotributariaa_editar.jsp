...
<div class="container">
    <div class="container-fluid">
        <c:url value="/sta_update" var="update"/>
        <form:form class="form-signin" modelAttribute="sta" id="FormCadastro" action="${update}" method="PUT">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 34%;">Editar Situação Tributária A</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="id_STA" type="text" maxlength="3"
