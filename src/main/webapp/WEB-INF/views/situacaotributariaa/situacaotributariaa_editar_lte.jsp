...
<div class="content-header">
    <h1>Editar Situação Tributária A</h1>
</div>

<div class="content body">
    <form action="/sta_update" method="post">
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="50" style="width:100%;" required="autofocus" value="${sta.descricao}"
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="col-sm-12" style="margin-top: 15px; text-align: center;">
                                ...
                                <a style="width: 80px" href="<c:url value="/sta_lista"/>" class="btn btn-primary" title="Cancelar">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
