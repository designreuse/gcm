...
<div class="container">
    <div class="container-fluid">
        <c:url value="/sta_insert" var="gravar"/>
        <form:form class="form-signin" modelAttribute="sta" id="FormCadastro" action="${gravar}" method="POST">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 34%;">Nova Situação Tributária A</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span8" style="text-align: left;">
                        <form:input path="codigoSTA" type="text"  maxlength="50" required="autofocus"
                                    class="form-control" name="codigoSta" placeholder="Código"
                                    style="width:80px;" />
                    </div>
                </div>
                <div class="row-fluid">
                ...
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <div class="row-fluid">
                            ...
                            <div class="span6">
                                <a class="btn btn-lg btn-primary btn-block" style="width:100px;" href="<c:url value="/sta_lista"/>">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
