...
<div class="content body">
    <form action="/empresa_update" method="post" >
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="13" style="width:100%;" required="autofocus" value="${empresa.cnpj}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="100" style="width:100%;" required="true" value="${empresa.razaoSocial}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="100" style="width:100%;" value="${empresa.nomeFantasia}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="20" style="width:100%;" value="${empresa.inscricaoEstadual}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="20" style="width:100%;" value="${empresa.inscricaoMunicipal}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="50" style="width:100%;" value="${empresa.endereco}"
                                        ...
                                        <div class="col-md-1">
                                            <input type="text" maxlength="5" style="width:100%;" value="${empresa.numero}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="50" style="width:100%;" value="${empresa.bairro}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="9" style="width:100%;" value="${empresa.cep}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="15" style="width:100%;" value="${empresa.telefone1}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="15" style="width:100%;" value="${empresa.telefone2}"
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="15" style="width:100%;" value="${empresa.fax}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="100" style="width:100%;" value="${empresa.email}"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="100" style="width:100%;" value="${empresa.url}"
                    ...
                    <div class="box box-primary">
                        <div class="box-body">
                            <div class="col-sm-12" style="margin-top: 15px; text-align: center;">
                                ...
                                <a style="width: 80px" href="<c:url value="/empresa_lista"/>" class="btn btn-primary" title="Cancelar">Cancelar</a>
                            </div>
                        </div>
                    </div>
                </div>
