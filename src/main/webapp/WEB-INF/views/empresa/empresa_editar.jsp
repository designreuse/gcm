...
<div class="container">
    <div class="container-fluid">
        <c:url value="/empresa_update" var="updateempresa"/>
        <form:form class="form-signin" modelAttribute="empresa" id="FormCadastro" action="${updateempresa}" method="PUT">
            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Editar Empresa</a>
                    </div>
                </div>
            </div>
            ...
            <div class="container-fluid navbar navbar-inner">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span9" style="text-align: left;">
                        <form:input id="id_Empresa" path="id_Empresa" type="text"
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3" style="text-align: left;">
                        <form:input path="InscricaoEstadual" type="text" maxlength="20"
                                    class="form-control"  name="Insc_Estadual" placeholder="Insc Estadual"
                                    style="width:160px;" />
                    </div>
                    ...
                    <div class="span3" style="text-align: right;">
                        <form:input path="InscricaoMunicipal" type="text" maxlength="20"
                                    class="form-control" name="Insc_Municipal" placeholder="Insc Municipal"
                                    style="width:160px;" />
                    </div>
                </div>
                <div class="row-fluid">
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3" style="text-align: left;">
                        <form:select path="id_Pais" multiple="false" id="listaPais"
                    ...
                    <div class="span3" style="text-align: right;">
                        <form:input path="id_Uf" id="id_uf_imput" type="hidden" maxlength="50" class="form-control" name="id_uf" placeholder="id_uf" style="width:80px;" />

                        <form:select  path="id_Uf"  multiple="false" id="listaUf"
                                      style="width:200px;" onchange="getval(this);" cssClass="form-control" required="true"
                                      itemLabel="siglauf"
                                      itemValue="id_uf"/>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span9" style="text-align: left;">
                        <form:input path="id_Municipio" id="id_municipio_imput" type="hidden" maxlength="50" class="form-control" name="id_Municipio" placeholder="id_Municipio" style="width:80px;" />
...
<script>
    ...
    $("#listaMunicipio").change(function(){
        $("#id_municipio_imput").val($("#listaMunicipio").val());
    });
