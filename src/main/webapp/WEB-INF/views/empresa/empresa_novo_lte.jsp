...
<div class="content body">
    <form action="/empresa_insert" method="post" >
        <fieldset>
            <div class="row">
                <div class="col-sm-12">
                            ...
                            <form class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="100" style="width:100%;" required="true"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <input type="text" maxlength="9" style="width:100%;"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="100" style="width:100%;"
                                                   class="form-control maiusculo" placeholder="E-Mail" name="email" id="email"/>
                                        </div>
                                    </div>
                                    <br>
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" maxlength="100" style="width:100%;"
                                                   class="form-control maiusculo" placeholder="Url" name="url" id="url"/>
                                        </div>
                                    </div>
                                </div>
                            </form>
...
<script>
    ...
    function carrega_municipio(id){
        ...
        $.getJSON("${pageContext.request.contextPath}/carregamunicipio-uf/"+id_uf,
                function(result){
                    $('#id_Municipio').empty();
                    $("#id_Municipio").append('<option></option>');
                    $.each(result, function(i){
