...
<div class="container">
    <div class="container-fluid">
        <c:url value="/contacorrente_insert" var="gravar"/>
        <form:form class="form-signin" modelAttribute="contacorrente" id="FormCadastro" action="${gravar}" method="POST">

            <div class="navbar">
                <div class="navbar-inner">
                    <div class="container-fluid">
                        <a class="brand" style="font: bold;  margin-left: 38%;">Nova Conta Corrrente</a>
                    </div>
                </div>
            </div>
                ...
                <div class="row-fluid">
                    ...
                    <div class="span3" style="text-align: left;">
                        <form:input path="saldoConta" type="number"  maxlength="20" required="false" readonly="true"
                                    class="form-control" name="SaldoConta" placeholder="Saldo" value="0"
